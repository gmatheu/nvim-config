-- Source: https://raw.githubusercontent.com/LazyVim/LazyVim/8ba7c64a7da9e46f2ac601919508803824208935/lua/lazyvim/util/mini.lua
...
return {
  ...
  config = function()
    vim.api.nvim_create_autocmd("User", {
      pattern = "LazyDone",
      callback = function()
        vim.schedule(function() M.ai_whichkey() end)
      end,
    })
